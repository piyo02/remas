	...
	<div class="container">
		<div class="row align-items-center">
			<div class="col-12 col-lg-8">
				...
				<div class="breaking-news-area d-flex align-items-center">
					...
					<div id="breakingNewsTicker" class="ticker">
						<ul>
							<li><a href="#">Judul Besar</a></li>
							<li><a href="#">Isi konten</a></li>
							<li><a href="#">yang ringkas</a></li>
						</ul>
					</div>
				</div>
				...
				<div class="breaking-news-area d-flex align-items-center mt-15">
					...
					<div id="internationalTicker" class="ticker">
						<ul>
							<li><a href="#">Judul Blog terbaru</a></li>
							<li><a href="#">isi blog</a></li>
							<li><a href="#">secara ringkas</a></li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="col-12 col-lg-4">
				<div class="hero-add">
					<a href="#"><img src="<?= base_url('front-assets/img/bg-img/') ?>hero-add.gif" alt=""></a>
				</div>
			</div>
		</div>
	</div>
			...
			foreach ($caretakers as $caretaker) :
				...
				<div class="col-md-4 intro_col">
					<div class="intro_item">
						...
						<center>
							<h4><b><?= $caretaker->description ?></b></h4>
						</center>
					</div>
				</div>
			<?php
											...
											<div class="post_content">
												...
												<div class="post_info d-flex flex-row align-items-center justify-content-start">
													<div class="post_author d-flex flex-row align-items-center justify-content-start">
														<div>
															<div class="post_author_image"><img src="<?= $news->author_image ?>" alt=""></div>
														</div>
